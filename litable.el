...
(defvar litable-pure-functions-list
  '(* / % + - -zip LaTeX-back-to-indentation
      ...
      match-end match-string match-string-no-properties max mc/create-fake-cursor-at-point member memq
      ...
      region-active-p one-window-p number-or-marker-p msc/buffer-is-client-p mc/fake-cursor-p latex/do-auto-fill-p jabber-muc-sender-p
      jab/buffer-p is-on-header-p integer-or-marker-p in-string-p gl--is-inside-math-p file-writable-p file-remote-p
